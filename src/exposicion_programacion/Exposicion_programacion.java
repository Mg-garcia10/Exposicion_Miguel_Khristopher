 ...
 * @author Miguel
 */
public class Exposicion_programacion {
    ...
    public static void main(String[] args) {
        ...
        Veterinaria veterinaria = new Veterinaria ("Pet Plaza,","Col. Las minitas, Calle Venezia #2467,, Av. Juan Lindo, Tegucigalpa",
                                                    "9695-1456","Abierto las 24 horas", "****");
